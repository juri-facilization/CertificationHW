define("UsrRealty_FormPage", /**SCHEMA_DEPS*/["@creatio-devkit/common"]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/(sdk)/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			{
				"operation": "insert",
				"name": "RunGenerateVisitsProcessButton",
				"values": {
					"type": "crt.Button",
					"caption": "#ResourceString(RunGenerateVisitsProcessButton_caption)#",
					"color": "default",
					"disabled": false,
					"size": "medium",
					...
					"clicked": {
						...
						"params": {
							"processName": "UsrGenerateVisitsProcess",
							"processRunType": "ForTheSelectedPage",
							"saveAtProcessStart": true,
							"showNotification": true,
							"recordIdProcessParameterName": "ParentRealtyIdParameter"
						}
					},
					"clickMode": "default",
			...
			},
			{
				...
				"values": {
					...
					"type": "crt.NumberInput",
					"label": "$Resources.Strings.PDS_UsrComission_3leezdx",
					"labelPosition": "auto",
					"control": "$PDS_UsrComission_3leezdx",
					"visible": true,
					"readonly": true,
					"placeholder": "",
					"tooltip": ""
			...
			},
			{
				...
				"values": {
					...
					"type": "crt.NumberInput",
					"label": "$Resources.Strings.PDS_UsrOfferTypeUsrCommissionPercent_5cni0sl",
					"control": "$PDS_UsrOfferTypeUsrCommissionPercent_5cni0sl",
					"readonly": true,
					"placeholder": "",
					"labelPosition": "auto",
					"tooltip": ""
		...
		viewModelConfigDiff: /**SCHEMA_VIEW_MODEL_CONFIG_DIFF*/[
			{
				...
				"values": {
					...
					"PDS_UsrPrice_4eso9rs": {
						...
						"validators": {
							"MySuperValidator": {
								...
								"params": {
									"comparisonValue": 0,
									"message": "#ResourceString(MustBeGreaterThanZero)#"
								}
							}
						}
					},
					...
					"PDS_UsrComission_3leezdx": {
						"modelConfig": {
							"path": "PDS.UsrComission"
						}
					},
					"PDS_UsrOfferTypeUsrCommissionPercent_5cni0sl": {
						"modelConfig": {
							"path": "PDS.UsrOfferTypeUsrCommissionPercent_5cni0sl"
						}
					}
				}
			},
				...
				"values": {
					"PDS": {
						...
						"config": {
							"entitySchemaName": "UsrRealty",
							"attributes": {
								"UsrOfferTypeUsrCommissionPercent_5cni0sl": {
		...
		handlers: /**SCHEMA_HANDLERS*/[
	        ...
	        },
			{
				...
				handler: async (request, next) => {
      					if (request.attributeName === 'PDS_UsrPrice_4eso9rs' || 				    // if price changed
					   request.attributeName === 'PDS_UsrOfferTypeUsrCommissionPercent_5cni0sl' ) { // or percent changed
						var price = await request.$context.PDS_UsrPrice_4eso9rs;
						var percent = await request.$context.PDS_UsrOfferTypeUsrCommissionPercent_5cni0sl;
						var commission = price * percent / 100;
						request.$context.PDS_UsrComission_3leezdx = commission;
					}
			...
			"usr.DGValidator": {
				validator: function (config) {
					return function (control) {
						...
						let comparisonValue = config.comparisonValue;
						let valueIsCorrect = value > comparisonValue;
						var result;
						if (valueIsCorrect) {
							result = null;
						} else {
